...
CLOCK_SIG_NAMES = ['clk', 'clock']
NORMAL_RESET_SIG_NAMES = ['reset', 'rst']
INVERTED_RESET_SIG_NAMES = ['resetn', 'rstn']

RESET_SIG_NAMES = NORMAL_RESET_SIG_NAMES + INVERTED_RESET_SIG_NAMES

CLK_RST_SIG_NAMES = CLOCK_SIG_NAMES + RESET_SIG_NAMES
